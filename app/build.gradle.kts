...
android {
    ...
    defaultConfig {
        applicationId = "com.sncap.mybrowser"
        minSdk = 24
        targetSdk = 35
    ...
    buildTypes {
        ...
        debug {
            ...
            resValue("string", "app_name", "myBrowser Debug")
        }
    }
    ...
    productFlavors {
        ...
        create("githubPreview") {
            ...
            resValue("string", "app_name", "myBrowser Preview")
        }
    ...
    applicationVariants.all {
        outputs.all {
            (this as com.android.build.gradle.internal.api.BaseVariantOutputImpl).outputFileName =
                "myBrowser-${defaultConfig.versionName}-${name}.apk"
        }
    }
